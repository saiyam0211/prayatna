...
export default function LoginPage() {
  ...
  const handleNext = async () => {
    ...
    if (currentStep === "email") {
      ...
      try {
        ...
        setError("Invalid employee ID or password. Please contact your administrator.");
      }
    }
  ...
  const validateEmail = (email: string) => {
    // Allow employee IDs (alphanumeric) or email addresses
    ...
    >
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-[#6B7280]">
          {currentStep === "email" && "Sign in with your school-provided credentials"}
            ...
            >
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-sm text-[#6B7280]">
                    Enter your employee ID or school email address
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      {currentStep === "email" && (
        <div className="mt-6 text-center text-sm text-[#6B7280]">
          <p>Access restricted to authorized school personnel only</p>
        </div>
      )}
    </motion.div>
  );
